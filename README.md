...
**Hello react with rails** is  build using react on rails in one repo to display random greeting.   
...
```
git clone https://github.com/fithamlak/hello-rails-react-app.git
```
...
Feel free to check the [issues page](https://github.com/fithamlak/hello-rails-react/issues).
